...
class InterfazApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(os.path.join(os.getcwd(), "src", "imagen", "bbva.ico")))
        ...
        image = QPixmap(os.path.join(os.getcwd(), "src", "imagen", "im_bbva.png")).scaled(110, 40, Qt.AspectRatioMode.KeepAspectRatio)
        image_label = QLabel()
...
class InterfazValidador(InterfazApp):
    ...
    def __init__(self):
        ...
        title_label.setStyleSheet("color: #00b89f;; font: bold 30px Arial; margin-bottom: 50px;")

        self.folder_label = QLabel("Malla adjuntada: ", parent=self)
        ...
        # attachment_button.setStyleSheet("color: white; font: bold 15px Arial; background: #414bb2; border-color: white; border-style: solid; border-width: 1px; padding: 10px 10px;")
        ...
        validate_button.setStyleSheet("color: white; font: bold 35px Arial; background: #00b89f; border-color: white; padding: 5px; border-style: solid; border-width: 3px; margin-top: 30px; margin-bottom: 30px;")
        ...
        self.validation_textbox.setStyleSheet(
            "font-size: 16px; color: #333333; background-color: #F0F8FF; margin-left: 30px; margin-right: 30px;"
        )
        ...
        download_button.setStyleSheet("color: white; font: bold 20px Arial; margin-right: 30px; padding: 5px; background: #414bb2; border-color: white; border-style: solid; border-width: 1px; padding-top: 3px; padding-bottom: 3px;")
